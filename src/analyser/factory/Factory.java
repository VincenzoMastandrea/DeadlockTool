...
public class Factory extends com.gzoumix.semisolver.factory.Factory {
  ...
  public ObjKindVar newObjKindVar() {
	    ObjKindVar res = new ObjKindVar(new Variable());
	    return res;
	  }
  ...
  public TermVariable freshTermVariableFromTerm(Term t) {
    ...
    else if(t instanceof ObjKind) { return newObjKindVar(); }  
    else{ System.out.println("WHAT THE HELL !!!??? ->>" + t.getClass().toString()); return super.freshTermVariableFromTerm(t); }
  }
